(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~login-with-otp-and-forget-password-login-with-otp-and-forget-password-module~otpgeneration-o~d63b8c78"],{
...
var SendotpService = /** @class */ (function () {
    function SendotpService(http) {
        this.http = http;
        this.APIBaseUrl = 'http://www.jobability.org/';
    }
    ...
    SendotpService.prototype.verifyOTP = function (OTP, mobileNumber) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            _this.http.post(_this.APIBaseUrl + "api/registration/verifyotp", postData, requestOptions)
                .subscribe(function (response) {
                console.log("Data", response.json());
                resolve(response.json());
            }, function (error) {
...
var AuthservicesService = /** @class */ (function () {
    ...
    AuthservicesService.prototype.registerUser = function (otpverify, profileType, mobile, email, password, name, partner_id) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            var requestOpt = new _angular_http__WEBPACK_IMPORTED_MODULE_2__["RequestOptions"]();
            var headers = new _angular_http__WEBPACK_IMPORTED_MODULE_2__["Headers"]();
    ...
    AuthservicesService.prototype.open_R_and_A_Portal = function (postData) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            headers.set('Content-Type', 'application/json');
            requestOpt.headers = headers;
            _this.http.post(_this.APIBaseUrl + 'api/registration/redirect_rna_portal', postData, requestOpt).subscribe(function (response) {
                console.log("Data", response.json());
                resolve(response.json());
            }, function (error) {
                console.log("Error", error);
...
//# sourceMappingURL=default~login-with-otp-and-forget-password-login-with-otp-and-forget-password-module~otpgeneration-o~d63b8c78.js.map